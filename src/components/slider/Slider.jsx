...
const Slider = () => {
  return (
    <section id="sliderSection" className="slider__wrap cafe5">
          ...
          <div className="slider s1 container">
            ...
            <div className="img" aria-label="hidden">
              ...
              <Image 
                width={300}
                height={300}
                src="/assets/images/slider/bell.png" alt="이미지" 
              />
              {/* <img src="./assets/images/slider/calendar.png" alt="이미지2" /> */}
              <Image 
                width={300}
                height={300}
                src="/assets/images/slider/calendar.png" alt="이미지" 
              />
              {/* <img src="./assets/images/slider/clapperboard.png" alt="이미지3" /> */}
              <Image 
                width={300}
                height={300}
                src="/assets/images/slider/clapperboard.png" alt="이미지" 
              />
            </div>
